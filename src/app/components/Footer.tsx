	...
	return (
		<div className="h-47">
			<div className={`h-36 border-b-1 dark:border-white/9 border-black/9`}>
				<div
					className={`mx-[11%] htps-bg-line border-black/9  dark:border-white/9 border-x-1 h-full`}
				>
					<div
						className={`mx-[2%] bg-white border-black/9 dark:bg-black dark:border-white/9 border-x-1 h-full flex`}
					>
						<div className="pr-20 pl-2 pt-4 flex-1 flex flex-col">
							<p className="text-ml font-bold mb-1">Learn</p>
							<Link className="text-sm mb-1 hover:underline" href="/website">
								Documentation
							</Link>
							<Link className="text-sm mb-1 hover:underline" href="/website">
								Showcase
			...
			<div className="h-full">
				...
				>
					<div
						className={`mx-[2%] bg-white border-black/9 dark:bg-black dark:border-white/9 border-x-1 h-full`}
					>
