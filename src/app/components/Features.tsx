...
22 \t\t\t........`;
	...
	return (
		<div
			className={`h-330 border-b-1 border-black/9 dark:border-white/9 flex flex-col`}
		>
			{/* Up Space */}
			<div className="h-[16%] border-b-1 border-black/9 dark:border-white/9">
				<div
					className={`mx-[11%] h-full htps-bg-line border-x-1 border-black/9 dark:border-white/9`}
				>
					<div
						className={`mx-[2%] h-full bg-white dark:bg-black border-x-1 border-black/9 dark:border-white/9`}
					>
			...
			{/* Title */}
			<div
				className={`mx-[11%] htps-bg-line border-x-1 border-black/9 dark:border-white/9`}
			>
				<div
					className={`mx-[2%] h-full bg-white dark:bg-black border-x-1 border-black/9 dark:border-white/9 flex flex-col`}
				>
			...
			<div className="border-y-1 border-black/9 dark:border-white/9">
				<div
					className={`mx-[11%] dark:border-white/9 htps-bg-line border-x-1 border-black/9 dark:border-white/9`}
				>
					<div
						className={`mx-[2%] h-full bg-white dark:bg-black border-x-1 border-black/9 dark:border-white/9 py-[1%]`}
					>
